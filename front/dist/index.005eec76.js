        ...
        $.ajax({
            ...
            success: function(data) {
                data.forEach((element)=>{
                    $('tbody').append($('<tr>').append($('<td>').text(element.nombre)).append($('<td>').text(element.deporte)).append($('<td>').attr('class', 'precio').text(parseFloat(element.apuesta).toFixed(2) + " \u20AC")).append($('<td>').text(mostrarResultado(element.resultado))).append($('<td>').attr('class', 'tdBotones').append($('<button>').addClass('btn btn-dark btn-sm botonMaestro ganar').attr('data-id', element.id).text('Ganar'))).append($('<td>').attr('class', 'tdBotones').append($('<button>').addClass('btn btn-dark btn-sm botonMaestro perder').attr('data-id', element.id).text('Perder'))).append($('<td>').attr('class', 'tdBotones').append($('<button>').addClass('btn btn-dark btn-sm botonMaestro borrar').attr('data-id', element.id).text('Borrar'))).append($('<td>').attr('class', 'tdBotones').append($('<button>').addClass('btn btn-dark btn-sm botonMaestro detalle').attr('data-id', element.id).text('Ver Detalle'))));
                });
            },
